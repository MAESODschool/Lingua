...
const MEMORY_BREAKER_IMAGE_PATH = "assets/enemies/memory_breaker_battle_idle_v3.gif";
...
const LESSON_SEGMENTS = {
  ...
  "regular-rule-1": {
    ...
    teacherExplanation: [
      "เศษเสี้ยวแห่งอดีตเริ่มตอบรับเจ้าแล้ว แต่พลังนั้นจะเปิดได้ก็ต่อเมื่อคำกริยาถูกแปลงเป็นรูปอดีต",
      "คำกริยาปกติในภาษาอังกฤษเรียกว่า Regular Verbs",
      "Regular Verbs คือคำกริยาที่เดินตามกฎ ไม่ได้เปลี่ยนร่างแปลกไปเหมือนคำกริยาพิเศษบางคำ",
      "กฎพื้นฐานที่สุดของมันเรียบง่ายมาก คือ เติม -ed ต่อท้ายคำกริยา",
      "เมื่อเติม -ed แล้ว คำกริยาจะบอกว่าเหตุการณ์นั้นเกิดขึ้นและจบลงแล้ว",
      "เช่น walk หมายถึง เดิน แต่ walked หมายถึง เดินไปแล้ว",
      "กฎนี้ใช้กับคำกริยาทั่วไป ส่วนกฎพิเศษอื่น ๆ เราจะเรียนในประตูถัดไป",
      "จงจำคาถาแรกของ Regular Verbs ให้มั่น: verb ปกติ + -ed = past"
    ],
    teacherExamples: [
    ...
    preBossDialogue: [
      "ดีมาก คาถา -ed เริ่มส่องแสงในมือของเจ้าแล้ว",
      "ต่อจากนี้ Echo Tick จะทดสอบว่าเจ้าเข้าใจกฎ ไม่ใช่แค่จำคำจากตัวอย่าง",
      "มองหาคำกริยาทั่วไป แล้วประทับ -ed ให้ถูกต้อง"
    ],
    postBossDialogue: [
  ...
  "regular-rule-2": {
    ...
    teacherExplanation: [
      "กฎต่อไปซ่อนอยู่ที่ตัวอักษรสุดท้ายของคำ",
      "บางคำกริยามี e อยู่ท้ายคำอยู่แล้ว เช่น like, love, move และ live",
      "เมื่อคำมี e เฝ้าอยู่ปลายคำ เจ้าไม่จำเป็นต้องเรียก e มาเพิ่มอีก",
      "ให้เติมเพียง -d ต่อท้ายคำ พลังอดีตก็จะสมบูรณ์",
      "ดังนั้น love จะเป็น loved ไม่ใช่ loveed",
      "และ like จะเป็น liked ไม่ใช่ likeed",
      "จำให้ดี ถ้าท้ายคำมี e อยู่แล้ว ให้เติมแค่ d",
      "นี่คือคาถาของประตู Ending e: e + d กลายเป็นรูปอดีต"
    ],
    teacherExamples: [
    ...
    preBossDialogue: [
      ...
      "ก่อนเดินต่อ จงจำไว้ว่าอย่าปล่อยให้ e ซ้ำจนคาถาบิดเบือน",
      "บอสจะไม่ได้ถามคำเดิมเสมอไป มันจะดูว่าเจ้ามองท้ายคำเป็นหรือไม่"
    ],
    postBossDialogue: [
